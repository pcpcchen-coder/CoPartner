...
| 檔案 | 內容 |
|---|---|
| [`assets/deck/`](assets/deck/) | **簡報檔（.pptx）**——20 頁、16:9、每頁附講者備忘稿，依 `planning/ppt-material.md` 的大綱產出。含產生器 `gen.js`（deck 不要手改，改產生器後重跑）|
...
3. **衍生視圖最後同步**：`project-mindmap.md`、`assets/panorama.html`、`assets/deck/gen.js`（後兩者的數字都是硬寫的，改進度時要一起改）、根目錄 `README.md`／`README.en.md`、`CHANGELOG.md`、`planning/ppt-material.md`。
